...
(defn -main [& _]
  (let [db (store/seed-db)
    ...
    (println "== actuation/issue-pressure-test-certificate unit-1 (always escalates -- actuation/issue-pressure-test-certificate; carries a testlab-engagement-ref into the independent third-party accredited testing laboratory actor cloud-itonami-isic-7120) ==")
    (let [r (exec! actor "t5" {:op :actuation/issue-pressure-test-certificate :subject "unit-1"

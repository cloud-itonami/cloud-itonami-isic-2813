# Operator Quickstart — Manufacture of Other Pumps, Compressors, Taps and Valves

Shortest path from clone to a verified local dry-run for **ISIC 2813** (`cloud-itonami-isic-2813`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2813.git
cd cloud-itonami-isic-2813
```
...
- Blueprint governor key: `pressureequip-governor`
- Likely source path: `pressureequip.governor.cljc`
